  ...
  <div class="hero mt-[-4rem] min-h-screen text-primary-content">
    ...
    <div class="mx-20 grid">
      <p class="mb-5 text-center">
        Inspired from
        <a href="https://preview.keenthemes.com/metronic8/demo1/account/overview.html" class="font-bold" target="_blank">
          metronic </a>
      </p>

      <p class="mb-5 text-center">
        Used
        <a href="https://materialdesignicons.com/" class="font-bold" target="_blank"> MDI </a>
        icons as SVG format
      </p>

      <div class="flex">
        <span class="my-10 mx-auto text-center font-bold">
      ...
      <div class="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
        ...
        <div class="relative">
          <!-- User Avatar -->
          <img class="h-40 w-40 rounded-md object-cover" src="https://api.lorem.space/image/face?w=150&h=150" alt="User">

          <!-- Online Status Dot -->
          <div
            class="absolute -right-3 bottom-5 h-5 w-5 rounded-full border-4 border-white bg-green-400 sm:invisible sm:top-2 md:visible"
        ...
        <div class="flex flex-col px-6">
          ...
          <div class="flex h-8 flex-row">
            ...
            <!-- User Verified -->
            <svg
              class="my-auto ml-2 h-5 fill-blue-400" xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="my-2 flex flex-row space-x-2">
            ...
            <div class="flex flex-row">
              <svg
                class="mr-2 h-4 w-4 fill-gray-500/80" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"
              >
                <path
          ...
          <div class="mt-2 flex flex-row items-center space-x-5">
            ...
            >
              <div class="flex flex-row items-center justify-center">
                <svg
                  class="mr-3 fill-gray-500/95" xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"
                >
                  <path
        ...
        <div class="w-100 flex grow flex-col items-end justify-start">
          <div class="flex flex-row space-x-3">
            ...
            >
              <svg
                class="mr-2 fill-current" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            >
              <svg
                class="fill-gray-500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                version="1.1" width="24" height="24" viewBox="0 0 24 24"
              >
                <path
