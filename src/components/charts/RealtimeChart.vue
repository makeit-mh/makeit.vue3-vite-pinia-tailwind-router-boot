...
import {
  Chart, LineController, LineElement, LinearScale, PointElement, TimeScale, Tooltip,
} from "chart.js";
...
<template>
  <div class="px-5 py-3">
    <div class="flex items-start">
      ...
      <div ref="chartDeviation" class="text-sm font-semibold text-white px-1.5 rounded-full" />
    </div>
  </div>
  <div class="grow">
