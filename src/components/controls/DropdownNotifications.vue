...
<template>
  <div class="relative inline-flex">
    ...
    >
      ...
      <div class="absolute top-0 right-0 w-2.5 h-2.5 bg-red-500 border-2 border-white rounded-full" />
    </button>
    <transition
    ...
    >
      <div v-show="dropdownOpen" class="min-w-80 origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1" :class="align === 'right' ? 'right-0' : 'left-0'">
