...
<template>
  <div>
    ...
    >
      <div v-show="dropdownOpen" class="min-w-36 origin-top-right z-10 absolute top-full bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1" :class="align === 'right' ? 'right-0' : 'left-0'">
        <ul
          ref="dropdown"
